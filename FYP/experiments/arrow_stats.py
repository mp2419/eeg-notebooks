...
def extract_arrow_stats(json_file_path):
    with open(json_file_path, 'r') as file:
        ...
        left_arrow_delay = []
        right_arrow_delay = []
        stats = {'L_correct': 0, 'L_missed': 0, 'L_wrong': 0, 'R_correct': 0, 'R_missed': 0, 'R_wrong': 0, 'empty_call':0, 'L_delay_avg': 0, 'R_delay_avg':0, 'L_delay_std': 0, 'R_delay_std':0}
        prev_left = False
        prev_right = False
...
def merge_obj_performance(circles_file_path, eeg_json_path):
    ...
    with open(circles_file_path, 'r') as file:
        ...
        performance['circle_error'] = error
        performance['circle_error_pcg'] = error_pcg
