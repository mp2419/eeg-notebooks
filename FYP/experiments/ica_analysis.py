...
json_file_path = os.path.join(os.path.expanduser('~/'), 'Desktop', 'FYP', 'code_env', 'eeg-notebooks', 'FYP', 'data_ordered', 'data_json', 'ShapeVisual_04_1.json')
...
ica.plot_overlay(filtered_raw, exclude=[0], picks="eeg", title="ICA on Audio Stimulation - excluding component n° 0")
ica.plot_overlay(filtered_raw, exclude=[1], picks="eeg", title="ICA on Audio Stimulation - excluding component n° 1")
ica.plot_overlay(filtered_raw, exclude=[2], picks="eeg", title="ICA on Audio Stimulation - excluding component n° 2")
ica.plot_overlay(filtered_raw, exclude=[3], picks="eeg", title="ICA on Audio Stimulation - excluding component n° 3")
...
#------- NOT RELEVANT Plot the raw and cleaned data in time
