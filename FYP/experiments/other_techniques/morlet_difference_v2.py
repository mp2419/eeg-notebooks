...
def morlet_difference(raw_files, mode1="Audio", mode2="Vibro", rejection_th=7000000):
    ...
    fig.suptitle(f"Difference in Time-Frequency spectrum between {mode1} and {mode2} - event 'left'")
    ...
    fig.suptitle(f"Difference in Time-Frequency spectrum between {mode1} and {mode2} - event 'right'")
