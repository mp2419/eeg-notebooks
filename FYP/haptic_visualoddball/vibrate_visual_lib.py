...
__title__ = "Vibro-tactile Visual"
...
def show_instructions(duration,  mywin ):
    ...
    instruction_text = """
    Welcome to the Vibro-tactile Visual experiment! 

    You will see displayed circles of different colours, please COUNT the BLUE circles.

    Occasionally, you will feel a left or right vibration, please PRESS the LEFT or RIGHT arrow key accordingly.
